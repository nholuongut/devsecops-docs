...
* Katkit deploys a service in the same tenant with the docker image provided by nholuongut, which is essentially like a jenkins worker and has the Katkit agent in it.
